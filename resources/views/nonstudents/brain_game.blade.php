...
@section('styles')
    ...
    <!-- Preloader -->
    <link type="text/css" href="{{ asset('back/public/vendor/spinkit.css') }}" rel="stylesheet">

    <!-- Perfect Scrollbar -->
    <link type="text/css" href="{{ asset('back/public/vendor/perfect-scrollbar.css') }}" rel="stylesheet">

    <!-- Material Design Icons -->
    <link type="text/css" href="{{ asset('back/public/css/material-icons.css') }}" rel="stylesheet">

    <!-- Font Awesome Icons -->
    <link type="text/css" href="{{ asset('back/public/css/fontawesome.css') }}" rel="stylesheet">

    <!-- Preloader -->
    <link type="text/css" href="{{ asset('back/public/css/preloader.css') }}" rel="stylesheet">

    <!-- App CSS -->
    <link type="text/css" href="{{ asset('back/public/css/app.css') }}" rel="stylesheet">
@endsection
            ...
            ">
                    ...
                    <div class="quiz_box ">
                        ...
                        <footer>
                            ...
                            <button class="next_btn" style="float: right;background-color: #ed0b4c;border:#ed0b4c">Next
                                Question <i class="material-icons icon--right">keyboard_arrow_right</i></button>
                        </footer>
                    </div>
    @endif
