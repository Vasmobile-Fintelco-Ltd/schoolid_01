    ...
    <div class="container">
        ...
        <div class="inner-wrapper2 inner-login">
            ...
            <div class="inner-content-form">
                <h2>Enter M-Pesa code you received after payment</h2>
...
@endif     
                    ...
                    <form action="{{ route('mpesa_confirm') }}" method="POST" style="box-shadow: none; padding:20px 10px;">
                        @csrf
                    <div class="form-group">
                     
                        <input type="text" name="user_id" value="{{ $user_id }}" hidden>
                        <input type="text" name="mpesa" class="form-control" id="exampleInputName" aria-describedby="name" placeholder="Enter Phone Number">
                    </div>
